...
public class LoginControllerTest {
    ...
    public void postLogin_withValidUserCredentials_receiveLoggedInUserDTO() {
        ...
        ResponseEntity<UserDto> response = getUserInfo(Objects.requireNonNull(responseToken.getBody()).getToken(), UserDto.class);
    ...
    public <T> ResponseEntity<T> getUserInfo(String token, Class<T> responseType) {
        HttpEntity<String> entity = new HttpEntity<>("parameters",createHttpHeaders(token));
